...
namespace AssetStudioGUI
{
    ...
    internal static class Studio
    {
        ...
        public static void parseAssetItems(AssetsManager assetsManager, Dictionary<Object, AssetItem> objectAssetItemDic, 
            ref string productName, List<(PPtr<Object>, string)> containers, ref int i, List<AssetItem> exportableAssets, Action cb= null)
        {
        ...
        public static (string, List<TreeNode>) BuildAssetData(AssetsManager assetsManager)
        {
            ...
            parseAssetItems(assetsManager, objectAssetItemDic, ref productName, containers, ref i, exportableAssets, ()=> { Progress.Report(++i, objectCount); });
        ...
        public static Dictionary<string, SortedDictionary<int, TypeTreeItem>> BuildClassStructure(AssetsManager assetsManager)
        {
